    ...
    def ask(self, question="", answer="", last_question=False):
        ...
        if self.mode==0:
          resp="x"
            ...
            resp = self.ask_mode1(question=question, answer=answer, last_question=last_question)
        elif self.mode==2:
            resp = self.ask_mode2(question=question, answer=answer, last_question=last_question)
        elif self.mode==3:
            resp = self.ask_mode3(question=question, answer=answer, last_question=last_question)
        elif self.mode==4:
            resp = self.ask_mode4(question=question, answer=answer, last_question=last_question)
        return resp
