...
class Database:
    ...
    def tell_db_colnames(self):
        cols = [["user", "deck", "start_time", "end_time", "elapsed_time", "questions_n_total",
                 "questions_n_checked", "questions_n_answered", "questions_n_correct", "questions_percent_correct"]]
        return cols
    ...
    def write_to_db(self, output_csv_file="", rows_to_write=[], mode="a"):
        self.write_file(output_csv_file=self.db_path,
                        rows_to_write=rows_to_write, mode="a")
    ...
    def give_summary_of_db(self):
        ...
        msg = msg + str(sum(results)/len(results)) + \
